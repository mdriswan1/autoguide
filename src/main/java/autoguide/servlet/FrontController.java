 ...
 * 
 * this class is used for receiving signup,login,logout request validate the user credentials and forward to respected pages
 * 
 */
...
public class FrontController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/**
		 * execute method return true then go the success or else failure
		 */
		if (insert) {
