...
public class ServiceFactory {
	...
	static {
		try (InputStream fr = ServiceFactory.class.getClassLoader().getResourceAsStream("/autoguide/resource/resource.properties")) {
			properties.load(fr);
	...
	/**
	 * get the input, depends on the input get the serviceConfig object get the class_name from serviceConfig object and create the object
	 * and return it back
	 * 
	 * @param input
